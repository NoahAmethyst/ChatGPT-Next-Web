...
const id: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Akses tidak diizinkan, silakan masukkan kode akses atau masukkan kunci API OpenAI Anda. di halaman [autentikasi](/chatgpt#/auth) atau di halaman [Pengaturan](/#/settings).",
  },
  Auth: {
